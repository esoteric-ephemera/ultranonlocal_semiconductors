...
c Valence number of Al
         z = 3.d0
         Rp = 0.317d0

c Construct the fcc lattice
         ...
         Gvx=ik1p*b1x+ik2p*b1y+ik3p*b1z
         Gvy=ik1p*b2x+ik2p*b2y+ik3p*b2z
         Gvz=ik1p*b3x+ik2p*b3y+ik3p*b3z
...
c The analytic hx frequency-dependent core kernel with the optimized parameters determined by Aaron
           ...
           gam = 1.311d0
             ...
             h0p = h0**(4.d0/7.d0)
             hn = (1.d0 - c1*xk**2.d0)
             hd =(1.d0+ c2*xk**2 + ((c1/gam)**(1.d0/d))*(xk**c3))**(d)
             hxf = hn/hd
             hx = h0*hxf
             refxc = finf - cc*(bn**(3.d0/4.d0))*hx
           aimfxc=-cc*bn**(3.d0/4.d0)*xk/((1.d0+xk**2.d0)**(5.d0/4.d0))
